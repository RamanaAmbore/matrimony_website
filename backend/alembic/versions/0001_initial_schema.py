...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("gender", sa.Enum("bride", "groom", name="gender_enum", create_type=False), nullable=False),
        ...
        sa.Column("manglik", sa.Enum("yes", "no", "partial", "unknown", name="manglik_enum", create_type=False), nullable=False, server_default="unknown"),
        sa.Column("mother_tongue", sa.String(50), nullable=False, server_default="Telugu"),
        sa.Column("diet", sa.Enum("veg", "non-veg", "eggetarian", name="diet_enum", create_type=False), nullable=False),
        ...
        sa.Column("status", sa.Enum("draft", "pending", "approved", "rejected", name="profile_status_enum", create_type=False), nullable=False, server_default="draft"),
    ...
    op.create_table(
        ...
        sa.Column("profile_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("status", sa.Enum("pending", "approved", "rejected", name="request_status_enum", create_type=False), nullable=False, server_default="pending"),
