...
<div class="mx-auto max-w-3xl px-4 py-16">
	...
	<div class="card p-6 space-y-8">
		...
		<section>
			<h2 class="mb-0.5 font-serif text-2xl font-semibold text-maroon">Our Community</h2>
		...
		<section>
			<h2 class="mb-0.5 font-serif text-2xl font-semibold text-maroon">Privacy &amp; Safety</h2>
		...
		<section>
			<h2 class="mb-0.5 font-serif text-2xl font-semibold text-maroon">Contact</h2>
