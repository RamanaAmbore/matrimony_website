	...
	<div class="relative z-10 flex min-h-[88vh] flex-col items-center justify-center px-4 text-center">
		<div class="mx-auto max-w-3xl">
			...
			<p
				...
				lang="te"
				style="color: var(--color-saffron); -webkit-text-stroke: 0.8px var(--color-marigold); paint-order: stroke fill; text-shadow: 0 1px 4px rgba(0,0,0,0.9), 0 0 2px rgba(0,0,0,0.7);"
			>
